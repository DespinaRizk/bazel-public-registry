...
#define AUDIT_FIRST_USER_MSG                                                   \
  1100 /* Userspace messages mostly uninteresting to kernel */
...
#define AUDIT_FEATURE_BITMAP_ALL                                               \
  (AUDIT_FEATURE_BITMAP_BACKLOG_LIMIT |                                        \
   ...
   AUDIT_FEATURE_BITMAP_SESSIONID_FILTER | AUDIT_FEATURE_BITMAP_LOST_RESET |   \
